...
const createCountRanking = (rankingData) => __awaiter(void 0, void 0, void 0, function* () {
    rankingData.points = 0;
    // rankingData.isOwn = false
    const newRanking = yield Ranking_1.default.create(rankingData);
    return newRanking;
});
exports.default = createCountRanking;
